...
//{'data1':{'T1':fff,'T2':fff,'T3':fff},'data2':{'T1':fff,'T2':fff,'T3':fff}...}
    ...
    for (let k in keys)
    {
        ...
        T_min.push(data[keys[k]]['T_min']);
        T_av.push(data[keys[k]]['T_av']);
        T_max.push(data[keys[k]]['T_max']);
    ...
    var trace_T_min={x:Object.keys(data),
                     y:T_min,
                     name:'Temp. min.',
                     ...
                     line:{color:'rgb(0,0,255)',shape: 'spline'}};
    var trace_T_av={x:Object.keys(data),
                    y:T_av,
                    name:'Temp. śr.',
                    //mode: 'lines+markers+text',
                    //text:T_av,
                    ...
                    line:{color:'rgb(0,255,0)',shape: 'spline'}};
    var trace_T_max={x:Object.keys(data),
                     y:T_max,
                     name:'Temp. max.',
                     //mode: 'lines+markers+text',
                     //text:T_max,
                     ...
                     line:{color:'rgb(255,0,0)',shape: 'spline'}};

    console.log('temperatura min:');
    console.log(T_min);

    var dane=[trace1,trace2,trace3,trace_T_min,trace_T_av,trace_T_max];
    ...
    var layout={title:'Zużycie energii w poszczególnych dniach',barmode:'stack',xaxis: {tickangle:-90,title:'Dzień',legend:{traceorder:"normal"}},
                yaxis:{title:'Zużycie [kWh]',showgrid:false},yaxis2:{showgrid:false,title:'Temperatura [°C]',side:'right',overlaying:'y',anhor:'x'}}
